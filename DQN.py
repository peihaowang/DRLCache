...
class DeepQNetwork:
    def __init__(
        ...
        self.reward_threshold = e_greedy_threshold
        
        self.epsilons = list(e_greedy_init)
        if (e_greedy_init is None) or (e_greedy_increment is None) or (e_greedy_decrement is None):
    ...
    def learn(self):
        ...
        if (self.epsilons_increment is not None) and (self.epsilons_decrement is not None):
